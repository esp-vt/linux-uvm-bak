...
#define NV_DRM_DRM_COLOR_MGMT_H_PRESENT
...
#define NV_LINUX_DMA_FENCE_H_PRESENT
...
#undef NV_LINUX_HOST1X_NEXT_H_PRESENT
...
#define NV_LINUX_RESET_H_PRESENT
#define NV_LINUX_OF_PLATFORM_H_PRESENT
#define NV_LINUX_OF_DEVICE_H_PRESENT
#define NV_LINUX_OF_GPIO_H_PRESENT
#define NV_LINUX_GPIO_H_PRESENT
#define NV_LINUX_GPIO_CONSUMER_H_PRESENT
#define NV_LINUX_INTERCONNECT_H_PRESENT
#define NV_LINUX_PM_RUNTIME_H_PRESENT
#define NV_LINUX_CLK_H_PRESENT
#define NV_LINUX_CLK_PROVIDER_H_PRESENT
#undef NV_LINUX_IOASID_H_PRESENT
#define NV_LINUX_STDARG_H_PRESENT
#define NV_LINUX_IOSYS_MAP_H_PRESENT
#define NV_ASM_COCO_H_PRESENT
#define NV_LINUX_VFIO_PCI_CORE_H_PRESENT
#define NV_LINUX_MDEV_H_PRESENT
#define NV_SOC_TEGRA_BPMP_ABI_H_PRESENT
#define NV_SOC_TEGRA_BPMP_H_PRESENT
#define NV_LINUX_SYNC_FILE_H_PRESENT
#define NV_LINUX_CC_PLATFORM_H_PRESENT
#define NV_ASM_CPUFEATURE_H_PRESENT
#define NV_LINUX_MPI_H_PRESENT
