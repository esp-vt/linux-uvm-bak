...
deps_/usr/src/nvidia-550.127.05/nvidia/nv-p2p.o := \
  ...
  /usr/src/nvidia-550.127.05/nvidia/nv-ibmnpu.h \
  /usr/src/nvidia-550.127.05/nvidia/nv-rsync.h \
  /usr/src/nvidia-550.127.05/nvidia/nv-p2p.h \
  /usr/src/nvidia-550.127.05/nvidia/rmp2pdefines.h \

/usr/src/nvidia-550.127.05/nvidia/nv-p2p.o: $(deps_/usr/src/nvidia-550.127.05/nvidia/nv-p2p.o)

$(deps_/usr/src/nvidia-550.127.05/nvidia/nv-p2p.o):

/usr/src/nvidia-550.127.05/nvidia/nv-p2p.o: $(wildcard ./tools/objtool/objtool)
#SYMVER nvidia_p2p_init_mapping 0x45bb0ad7
#SYMVER nvidia_p2p_destroy_mapping 0x180f4b6a
#SYMVER nvidia_p2p_get_pages 0x5b3f3e79
#SYMVER nvidia_p2p_get_pages_persistent 0x970adefe
#SYMVER nvidia_p2p_free_page_table 0xf42ca687
#SYMVER nvidia_p2p_put_pages 0x642487ac
#SYMVER nvidia_p2p_put_pages_persistent 0xacdf3914
#SYMVER nvidia_p2p_dma_map_pages 0x1695ca38
#SYMVER nvidia_p2p_dma_unmap_pages 0x88d47c36
#SYMVER nvidia_p2p_free_dma_mapping 0x12a2e9b0
#SYMVER nvidia_p2p_register_rsync_driver 0x69686b5b
#SYMVER nvidia_p2p_unregister_rsync_driver 0xa12bd5f7
#SYMVER nvidia_p2p_get_rsync_registers 0x69bbcc13
#SYMVER nvidia_p2p_put_rsync_registers 0xd3c43b87
